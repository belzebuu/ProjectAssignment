...
def cml_parse() -> dict:
    ...
    parser.add_option('--prioritize_all', dest='prioritize_all', action='store_true', default=False, help="Whether to expand priority lists by appending as tie all non-prioritized projects. [default: %default]")
